...
namespace corsika
{
    ...
    int NucleusProperties::GetType() const
    {
        return fType;
    }
    
    std::string NucleusProperties::GetName() const
    {
    ...
    double NucleusProperties::GetAtomicNumber() const
    {
     ...
     */
    double NucleusProperties::GetMass() const
    {
    ...
    int NucleusProperties::TypeCode(const unsigned int theCharge, const unsigned int theAtomicNumber)
    {
        return kNucleusBase + kChargeFactor * theCharge + kAtomicNumberFactor * theAtomicNumber;
    }
    
    /// Check if type code is a valid nucleus
    bool NucleusProperties::IsNucleus(const int theType)
    {
