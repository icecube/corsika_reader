...
double
GaisserHillasParameter::Eval(const double depth)
  const
{
  if (depth <= fXZero)
    return 0;
...
void
GaisserHillasParameter::Dump(ostream& os)
  const
{
...
double
GaisserHillasParameter::GetIntegral()
  const
{
...
double
GaisserHillasParameter::GetIntegralError()
  const
{
  WARNING("not implemented!");
  return 0.;
