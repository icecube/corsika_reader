# -*- coding: utf-8 -*-
#
# corsika_reader documentation build configuration file, created by
# sphinx-quickstart on Fri Oct 14 13:37:25 2016.
#
...
project = u'corsika_reader'
copyright = u'2016, Javier Gonzalez'
...
htmlhelp_basename = 'corsika_readerdoc'
...
latex_documents = [
  (master_doc, 'corsika_reader.tex', u'corsika\\_reader Documentation',
...
man_pages = [
    (master_doc, 'corsika_reader', u'corsika_reader Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'corsika_reader', u'corsika_reader Documentation',
   author, 'corsika_reader', 'One line description of project.',
   'Miscellaneous'),
]
